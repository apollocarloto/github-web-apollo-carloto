...
- [x] Etapa 1 — Criar repositório
- [x] Etapa 2 — Editar README.md
- [ ] Etapa 3 — Criar pasta aulas/
- [ ] Etapa 4 — Criar arquivo HTML (na pasta aulas)
- [ ] Etapa 5 — Upload de arquivo
- [ ] Etapa 6 — Adicionar colaborador
- [ ] Etapa 7 — Excluir repositório (SIMULAÇÃO)

![Static Badge](https://img.shields.io/badge/Apollo-Carloto)
